...
const contactInfo = [
  ...
  },
  {
    icon: <SuEmail />,
    label: "Make a Quote",
    value: "vasudhaivaenterprises@gmail.com",
            ...
            >
              <div className="single-footer-widget">
                ...
                <div className="footer-content">
                  <p>
                    Vasudhaiv Enterprises is a trusted rooftop solar
                    installation company in Lucknow, serving homes, businesses,
                  ...
                  {recentPosts.map((post, index) => (
                    <div
                      ...
                      className={`recent-post-items ${
                        index === recentPosts.length - 1 ? "mb-0" : ""
                      }`}
                    >
                      <div className="thumb">
                        <Image
